# ✍️ Diário de Bordo - Amanda Aziz
**Papel:** Scrum Master & Gestão de Produto

Este documento registra minhas contribuições diárias e evolução técnica durante o projeto.
...
*   Para a Sprint 1, além da gestão do board, entreguei um pacote completo de artefatos de engenharia para a US09 (Localização de Pontos de Doação), garantindo que a funcionalidade possua requisitos mapeados, critérios de pronto/feito definidos e um log de bugs estruturado
