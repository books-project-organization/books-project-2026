...
# 📊 Relatório de Métricas e Análise de Desempenho – Sprint 2
...
* Melhor adaptação da equipe ao fluxo de trabalho ágil;
* Maior domínio das tecnologias utilizadas;
* Backlog mais refinado e organizado;
* Melhor divisão das responsabilidades entre os integrantes;
* Maior clareza nos critérios de aceite e no DoD.

Além disso, a equipe conseguiu reduzir retrabalho e aumentar a eficiência na execução das tasks técnicas.
...
Mesmo assim, o grupo conseguiu manter a Sprint estável e concluir as entregas planejadas.
